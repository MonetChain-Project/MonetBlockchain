 ...
 */
public class monetAsyncTimerVisitor implements AsyncTimerVisitor, SerializableEntity {
	private static final Logger LOGGER = Logger.getLogger(monetAsyncTimerVisitor.class.getName());
	 ...
	 */
	public monetAsyncTimerVisitor(final String timerName, final TimeProvider timeProvider) {
