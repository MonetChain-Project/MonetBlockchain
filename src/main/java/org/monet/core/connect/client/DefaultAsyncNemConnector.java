...
/**
 * A default AsyncmonetConnector implementation
 *
 * @param <TApiId> The api id type.
 */
public class DefaultAsyncmonetConnector<TApiId> implements AsyncmonetConnector<TApiId> {
	 ...
	 */
	public DefaultAsyncmonetConnector(
