...
import org.monet.core.model.mosaic.MosaicConstants;
import org.monet.core.model.primitive.Amount;
import org.monet.core.utils.SetOnce;
	...
	private static NetworkInfo createTestNetworkInfo() {
		...
		return new NetworkInfo(
				...
				new monetesisBlockInfo(
						Hash.fromHexString("16ed3d69d3ca67132aace4405aa122e5e041e58741a4364255b15201f5aaf6e4"),
						monetesisAddress,
						Amount.frommonet(8000000000L),
						"monetesis-testnet.bin"));
	}
	...
	private static NetworkInfo createMijinNetworkInfo() {
		...
		return new NetworkInfo(
				...
				new monetesisBlockInfo(
						Hash.fromHexString("16ed3d69d3ca67132aace4405aa122e5e041e58741a4364255b15201f5aaf6e4"),
						monetesisAddress,
						Amount.frommonet(9000000000L),
						"monetesis-mijinnet.bin"));
	}
}
