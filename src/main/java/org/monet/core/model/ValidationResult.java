...
public enum ValidationResult {
	...
	/**
	 * Validation failed because a transaction originated from the monetesis account after the monetesis block.
	 */
	FAILURE_monetESIS_ACCOUNT_TRANSACTION_AFTER_monetESIS_BLOCK(18),
	...
	/**
	 * Block was rejected because it was harvested by a blocked account (typically a reserved monet fund).
	 */
