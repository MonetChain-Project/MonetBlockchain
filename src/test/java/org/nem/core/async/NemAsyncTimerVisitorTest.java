...
public class monetAsyncTimerVisitorTest {

	@Test
	public void visitorIsInitializedWithDefaultValues() {
		// Arrange:
		final monetAsyncTimerVisitor visitor = new monetAsyncTimerVisitor("timer a", Mockito.mock(TimeProvider.class));
	...
	public void notifyOperationStartUpdatesVisitorStateCorrectly() {
		...
		final monetAsyncTimerVisitor visitor = new monetAsyncTimerVisitor("timer a", timeProvider);
	...
	private static void assertDefaultValuesWithLastDelayTime(
			final monetAsyncTimerVisitor visitor,
