...
public class HttpMethodClientTest {
	...
	private static class TestRunner {
		private static final String GOOD_URL = "http://bigalice2.monet.ninja/test.json";
		...
		public void sendReturnsJsonDeserializerOnSuccess() {
			...
			Assert.assertThat(deserializer.readString("test"), IsEqual.equalTo("org.monet.core.connect.HttpMethodClientTest"));
