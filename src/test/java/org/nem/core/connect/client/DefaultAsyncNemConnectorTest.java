...
public class DefaultAsyncmonetConnectorTest {
	...
	private static class TestContext {
		...
		private final DefaultAsyncmonetConnector<NisApiId> connector;
		...
		public TestContext() {
			...
			this.connector = new DefaultAsyncmonetConnector(this.httpClient, this.errorResponseStrategy);
