...
import org.monet.core.crypto.ed25519.arithmetic.MathUtils;
...
public class Ed25519DsaSignerTest extends DsaSignerTest {
	...
	public void isCanonicalReturnsFalseForNonCanonicalSignature() {
		...
		final byte[] input = org.monet.core.test.Utils.generateRandomBytes();
	...
	public void replacingRWithGroupOrderPlusRInSignatureRuinsSignature() {
		...
		byte[] input;
		while (true) {
			input = org.monet.core.test.Utils.generateRandomBytes();
