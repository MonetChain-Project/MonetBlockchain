package org.monet.core.model.namespace;

import org.hamcrest.core.IsEqual;
import org.junit.*;
import org.monet.core.test.IsEquivalent;

import java.util.Arrays;
import java.util.stream.Collectors;

public class ReservedNamespaceFilterTest {
	private static final String[] EXPECTED_RESERVED_ROOTS = { "monet", "user", "account", "org", "com", "biz", "net", "edu", "mil", "gov", "info" };
