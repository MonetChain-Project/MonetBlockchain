...
public class AccountInfoTest {
    ...
    public void infoCanBeCreatedWithoutPublicKey() {
        ...
        final AccountInfo info = new AccountInfo(
                ...
                Amount.frommonet(1234),
                Amount.frommonet(1222),
                new BlockAmount(7),
                "my account",
                2.3);
        ...
        Assert.assertThat(info.getBalance(), IsEqual.equalTo(Amount.frommonet(1234)));
        Assert.assertThat(info.getVestedBalance(), IsEqual.equalTo(Amount.frommonet(1222)));
    ...
    public void accountWithMultisigInfoCanBeBeRoundTripped() {
        ...
        final AccountInfo originalInfo = new AccountInfo(
                address,
                Amount.frommonet(747),
                Amount.frommonet(727),
                new BlockAmount(3),
                "alpha gamma",
                2.3,
    ...
    private static void assertAccountRoundTrip(
        ...
        Assert.assertThat(info.getBalance(), IsEqual.equalTo(Amount.frommonet(747L)));
        Assert.assertThat(info.getVestedBalance(), IsEqual.equalTo(Amount.frommonet(727L)));
    ...
    private static AccountInfo createAccountInfo(
        ...
        return new AccountInfo(address, Amount.frommonet(balance), Amount.frommonet(vestedBalance), new BlockAmount(blockAmount), label, importance, multisigInfo);
    }
