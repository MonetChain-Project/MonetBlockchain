...
public class AccountMetaDataTest {
    ...
    private static List<AccountInfo> createAccountInfos() {
        return Arrays.asList(
                new AccountInfo(Utils.generateRandomAddress(), Amount.frommonet(123), Amount.frommonet(111), new BlockAmount(234), "account1", 0.1),
                new AccountInfo(Utils.generateRandomAddress(), Amount.frommonet(345), Amount.frommonet(333), new BlockAmount(456), "account2", 0.2));
    }
