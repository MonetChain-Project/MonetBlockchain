...
public class AmountTest {
	...
	@Test
	public void canCreateAmountFrommonet() {
		// Act:
		final Amount amount = Amount.frommonet(11);

		// Assert:
		Assert.assertThat(amount.getNumMicromonet(), IsEqual.equalTo(11000000L));
		Assert.assertThat(amount.getNummonet(), IsEqual.equalTo(11L));
	}

	@Test
	public void canCreateAmountFromMicromonet() {
		// Act:
		final Amount amount = Amount.fromMicromonet(11);

		// Assert:
		Assert.assertThat(amount.getNumMicromonet(), IsEqual.equalTo(11L));
		Assert.assertThat(amount.getNummonet(), IsEqual.equalTo(0L));
	}
	...
	public void canBeCreatedAroundZeroAmount() {
		...
		// Assert:
		Assert.assertThat(amount.getNumMicromonet(), IsEqual.equalTo(0L));
	}
	...
	public void canBeCreatedAroundPositiveAmount() {
		...
		// Assert:
		Assert.assertThat(amount.getNumMicromonet(), IsEqual.equalTo(1L));
	}
	...
	@Test
	public void getNummonetRoundsDownToTheNearestWholemonet() {
		// Assert:
		Assert.assertThat(Amount.fromMicromonet(11000000L).getNummonet(), IsEqual.equalTo(11L));
		Assert.assertThat(Amount.fromMicromonet(11000001L).getNummonet(), IsEqual.equalTo(11L));
		Assert.assertThat(Amount.fromMicromonet(11999999L).getNummonet(), IsEqual.equalTo(11L));
	}
